    ...
    <div className="bg-gradient-to-r from-[#f1f5ff] via-[#e9f0ff] to-[#fdfdff]">
      <div className="px-4 py-14 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          >
            Discover the Future of <span className="text-brand">Software</span> Development
          </h2>
          <p
          ...
          >
            Innovative, reliable, and tailored software solutions designed to help
            your business grow. Experience seamless development with FastPay IT Company Limited.
          </p>
        </div>
        <div
