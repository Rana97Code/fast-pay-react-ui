...
const Industries = () => {
  const [activeTab, setActiveTab] = useState<number>(industriesData[0].id);
    ...
    <section className="w-full bg-gradient-to-r from-[#F1F8FE] via-[#D7E8FC] to-[#F1F8FE] py-20 px-4 lg:px-24">
      ...
      >
        ...
        <p className="text-lg leading-relaxed text-gray-700">
          Discover our extensive expertise across various industries. We provide
          tailored solutions to meet the unique needs of each sector.
        </p>
      </div>
