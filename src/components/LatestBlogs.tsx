...
import { GET_ALL_BLOG } from "../graphql/queries/blog.queries"; // Adjust path
import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";
import { BlogPost } from "../interface/landing.interface";
...
const LatestBlogs: React.FC = () => {
  ...
  if (loading) return <p className="py-20 text-center">Loading blogs...</p>;
  if (error)
    return (
      <p className="py-20 text-center text-red-600">Error loading blogs.</p>
    );

  const blogPosts = data.getAllBlogPosts;

  // Check if the number of blogs is more than 2
      ...
      <div className="py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl">
        <div className="mb-12 text-center">
          ...
          <p className="max-w-3xl mx-auto text-lg leading-relaxed text-gray-600">
            Explore our curated collection of articles and thought leadership
            pieces...
          </p>
        </div>
                  ...
                  <div className="flex items-center pt-4 mt-auto border-t border-gray-100">
                    <img
                      ...
                      onError={(e: React.SyntheticEvent<HTMLImageElement>) => {
                        ...
                        target.onerror = null;
                        target.src =
                          "https://placehold.co/100x100/E0E7FF/3689ce?text=User";
                      }}
                    />
                    <div className="ml-4">
