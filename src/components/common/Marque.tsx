const Marque = () => {
  const content = `Software Solutions for Every Industry: We offer cutting-edge solutions tailored to industries like finance, healthcare, education, retail, and more. Our team specializes in building scalable, secure, and innovative software that powers businesses to thrive in the digital age. Explore our diverse expertise and let us help you elevate your business!`;
