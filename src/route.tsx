...
import ChairmanPortfolio from "./pages/ChairmanPortfolio";
import ManagingDirectorPortfolio from "./pages/ManagingDirectorPortfolio";
...
export const routes = [
  ...
  { path: "/chairman", element: <ChairmanPortfolio /> },
  { path: "/managing-director", element: <ManagingDirectorPortfolio /> },
  { path: "/stakeholders", element: <Stakeholders /> },
  { path: "/expert-team", element: <ExpertTeam /> },
  {
    path: "/dashboard",
